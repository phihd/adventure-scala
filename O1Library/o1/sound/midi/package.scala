...
package object midi {
  ...
  private[midi] def reduceLogWarnings(): Unit = {
    // later: Replace: sun.* APIs are unsupported and are unusable since JDK9
    import sun.util.logging.PlatformLogger._

    // later: Replace: setLevel() is deprecated since JDK 9 as it doesn't always work
