...
/** '''O1Library''' is a toolkit designed for the course [[https://plus.cs.hut.fi/o1/2018/ 
 ...
 *  for playing sound. 
  ...
  * relevant programming concepts and related assignments. 
  * 
  ...
  *
  * O1Library has been developed by Aleksi Lukkarinen and Juha Sorva. Several of the key 
  * components in `o1.gui` and `o1.world` are built upon Aleksi’s 
  * [[https://github.com/Aalto-LeTech/Scala-Media-Computation Scala Media Computation Library]].
  * Some parts of O1Library draw inspiration from the “teachpacks” designed for the Racket 
  * programming language. 
  * 
  * We thank Riku Autio and Juhani Numminen for bug reports and fixes and Otto Seppälä for 
  * discussions.
  * 
