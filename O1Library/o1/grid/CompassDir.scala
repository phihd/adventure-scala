...
sealed abstract class CompassDir(val xStep: Int, val yStep: Int) { // The word sealed means that you can't directly inherit from this class except within this file. 
