...
private[gui] object ViewImpl {
  ...
  private[gui] abstract class ViewFrame[Model](initialState: Model, tickRate: Double, protected val title: String,
    ...
    private[o1] val swingFrame = new SimpleFrame(title) with Escapable {
