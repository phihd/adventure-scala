...
import o1.gui.PicHistory.Operations.CreationOperation
...
private[gui] trait ShapeAPI {
  ...
  private def creationOp(methodName: String, shapeName: String) = PicHistory(CreationOperation(methodName = methodName, simpleDescription = shapeName + "-shape"))
  private def creationOp(methodName: String): PicHistory = creationOp(methodName, methodName)
